...
export default function Home() {
  ...
  return (
    <main className="flex flex-col max-w-[880px] m-auto">
      ...
      <div>
        ...
        >
            <label className="block text-white text-lg font-bold mb-3" htmlFor="username">
              Describe your negative life event here:
            </label>
            <textarea 
                ref={inputRef}
      ...
      <div className='grid grid-cols-2 gap-x-8'>
        <div className="flex flex-col w-full pt-8">
          ...
          <div className="h-[400px] max-h-[400px] overflow-scroll bg-stone-800 rounded py-3 px-4">
            {originalInput}
          </div>
        ...
        <div className="flex flex-col w-full pt-8">
          ...
          <div className="h-full max-h-[400px] overflow-scroll bg-stone-800 rounded py-3 px-4">
