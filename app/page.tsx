  ...
  const initialMessages: Message[] = [
    {
      ...
      role: 'user', // 'ai' for messages generated by the AI, 'user' for user messages
      content: 'For each following journal entry I send you, please provide a quote from a famous philosopher or historical figure that may provide some guidance for this specific situation. Please include any supporting comments that are specific to the event described, including terminology from the journal entry. Please return the quote in bolded text.', // Message content
    },
    {
      id: '2', // Unique identifier for the message
      role: 'assistant', // 'ai' for messages generated by the AI, 'user' for user messages
