  ...
  const initialMessages = [
    {
      ...
      content: 'For each following message I send you, please provide a quote from a famous philosopher or historical figure that may provide some guidance. Please include any supporting comments. Please return the quote in bolded text.', // Message content
    },
    {
      id: '2', // Unique identifier for the message
      role: 'assistant', // 'ai' for messages generated by the AI, 'user' for user messages
      content: 'Ok, I understand.', // Message content
    },
  ];
