export const STRINGS = {
    EXAMPLES: [
        ...
        {
            title: "🐛 Pushing a Bug to Production",
            content: "Today turned out to be one of the most challenging days of my career so far. After deploying an update, a hidden bug slipped through, breaking a key feature for our users, leading to a flood of complaints and issues. The weight of responsibility is crushing—I'm dreading the conversation with my team and the steps we'll need to take to fix this. The fear of potential consequences for my mistake is keeping me up tonight, and I can't shake off the feeling of letting everyone down."
        },
        {
    ...
    INTRO: "AI Positivity Journal streams data from OpenAI’s Chat Completions API to provide reassurance, guidance, and perspective on any difficult situation we humans might face. Click the “Generate Positivity” button to hear quotes from philosophers, artists, writers, and other important historical figures."
}